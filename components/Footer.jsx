      ...
      <footer className = 'footer' style = {footerStyle}>
        <div className = 'outerFrame'>
          <div className = 'container'>
            <div className = 'leftSide' style = {{display: 'flex', flexDirection: 'column', fontSize: '30px'}}>
                <div className = 'specialFont' style = {{alignSelf: 'flex-end', paddingRight: '20px', paddingTop: '20px'}}>
                  Power by
                </div>
            ...
            <div className = 'rightSide divideLineBlackColor'>
              ...
              <div style = {{padding: '30px 0px 10px 0px'}}><a href = 'https://github.com/chenvan/rollawang'>网站源码</a></div>
